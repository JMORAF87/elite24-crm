    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-6 text-center">
        <div>
          ...
          <a href="/amarillo-security" className="text-neon-pink hover:underline">
            Return Home
          </a>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-black text-white font-sans">
      <nav className="p-6 border-b border-gray-800">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <a
            href="#contact"
            className="px-6 py-2 bg-neon-pink text-black font-bold hover:bg-pink-400 transition"
          >
            Get Quote
          </a>
        </div>
      ...
      <header className="py-20 px-6 text-center border-b border-gray-800 bg-[size:50px_50px] bg-[linear-gradient(to_right,#333_1px,transparent_1px),linear-gradient(to_bottom,#333_1px,transparent_1px)]">
        ...
        <div className="flex justify-center gap-4">
          <a
            href="#contact"
            className="px-8 py-4 bg-neon-pink text-black font-bold text-lg hover:transform hover:-translate-y-1 transition shadow-[4px_4px_0px_white]"
          >
            SECURE YOUR SITE
          </a>
          <a
